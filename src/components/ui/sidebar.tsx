...
import { LucidePanelLeftClose, LucidePanelRightClose, PanelLeft, PanelRight } from "lucide-react";
...
>(({ className, onClick, ...props }, ref) => {
    ...
    return (
        <Button
            ...
            {...props}
        >
            {state === "expanded" ? <LucidePanelLeftClose size={20} /> : <LucidePanelRightClose size={20} />}
